...
import 'package:flutter_date/features/date/presentation/widgets/button.dart';
...
import '../manager/date_display_bloc.dart';
...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider<DateDisplayBloc>(
      create: (context) => DateDisplayBloc(),
      child: SafeArea(
        child: Scaffold(
          appBar: AppBar(
